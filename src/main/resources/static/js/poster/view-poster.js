...
$(document).ready(function () {
    ...
    // 게시글 좋아요
    $("#poster-like-btn").click(function () {
        addLike();
    })
...
function addLike() {
    ...
    const posterId = $("#poster-like-btn").attr("data-poster-id");

    $.ajax("/api/posters/" + posterId + "/like", {
       type: "POST",
        beforeSend: function (xhr) {
           xhr.setRequestHeader(csrfHeader, csrfToken);
        },
        success: function (data) {
           const likeCountSpan = $("#poster-like-btn").next("span");
           const likeCount = parseInt(likeCountSpan.text());
