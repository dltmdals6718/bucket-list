                    ...
                    <li class="list-group-item">
                        <div>
                            <div class="d-flex">
                                ...
                                <div class="text-truncate align-self-center" style="font-size: 10pt; max-width: 150px;">
                                ...
                                <div class="ms-auto">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-chat-right-dots ms-1" viewBox="0 0 16 16">
                            ...
                            <div class="text-truncate" style="font-size: 10pt; max-width: 300px;">
                                <a class="link-dark link-underline-opacity-0 fw-semibold" href="/posters/${poster.posterId}">${poster.title}</a>
                            </div>
                        </div>
                    </li>
                `)
